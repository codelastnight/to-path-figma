...
var object2Point = function(object, pointArr: Array<Point>, curve, options: Formb, pass: Pass ) {
//
	let rotation
	...
	if (object.type != 'TEXT') object.x = 0 - centerX // kerning gets fucked up 
	console.log
	...
	// Rotate the object.
	object.rotation = 0
	if (options.rotCheck) object.relativeTransform = multiply(rotate(angle), object.relativeTransform)
...
export var text2Curve = function(node: TextNode, pointArr: Array<Point>, curve, options: Formb ) {
...
export var object2Curve = function(node: SceneNode, pointArr: Array<Point>, curve, options: Formb ) {
	const newNodes: SceneNode[] = []
	// values needed to pass between each objects
	let pass: Pass = {
