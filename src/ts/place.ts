...
var place = function(object: SceneNode, point: Point, options: Formb, curve: VectorNode) {
//set locations
	...
	object.relativeTransform = multiply(
		move(point.x + curve.relativeTransform[0][2], point.y + curve.relativeTransform[1][2]),
